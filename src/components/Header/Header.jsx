...
import userOptionIcon from "../../assets/userOptionIcon.png";
              ...
              {isLoggedIn && (
                <li>
                  <NavLink
                    to={"OptionsUser"}
                    className={({ isActive }) =>
                      `block py-2 pr-4 pl-3 duration-200 text-2xl mt-4 ml-8 ${
                        isActive ? "text-orange-700" : "text-gray-600"
                      } border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 hover:text-orange-700 lg:p-0`
                    }
                  >
