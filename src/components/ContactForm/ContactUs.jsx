...
function ContactUs() {
  ...
  const sendEmail = async () => {
    ...
    const response = await fetch(`https://localhost:3000/email/sendEmail`, {
      method: "POST",
        ...
        <div className="flex flex-wrap w-full ">
          <div className="w-full md:w-8/12 mb-4 md:mb-0">
            <div className="bg-gray-100 p-6 rounded-md">
              <form className="bg-teal-100" onSubmit={sendEmail}>
                <div className="mb-4">
                  <label
                    htmlFor="name"
                ...
                <div className="mb-4">
                  ...
                  >
                    ...
                    <option value="others">
                      OTHERS / Please write in Message Your Subject
                    </option>
                  </select>
                </div>
                <div className="mb-4">
          ...
          <div className="w-full md:w-4/12 ">
            <div className="text-center">
              ...
              <address className="mb-4 text-center">
                ...
                <br />
                <br />
                <strong>Phone :</strong> +91 73xxxxxx50
              </address>
